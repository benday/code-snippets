...
$csharpPath = "$env:OneDriveCommercial\Documents\Visual Studio 2022\Code Snippets\Visual C#\My Code Snippets"
$xamlPath = "$env:OneDriveCommercial\Documents\Visual Studio 2022\Code Snippets\XAML\My XAML Snippets"
